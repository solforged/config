...
(defvar dotfiles/local-leader-map (make-sparse-keymap)
  "Keymap shared between comma and SPC m.")
...
(defmacro dotfiles/local-leader-def (&rest args)
  ...
  `(general-define-key
    ...
    :keymaps 'override
    :prefix ","
    :prefix-map dotfiles/local-leader-map
    ,@args))
...
(use-package general
  ...
  (dotfiles/leader-def
    ...
    "m" '(:keymap dotfiles/local-leader-map :which-key "mode")
...
(use-package which-key
  ...
  :config
  (push '((nil . "window [1-9]") . t) which-key-replacement-alist)
  (which-key-mode 1))
...
(with-eval-after-load 'general
  ...
  (dotfiles/leader-def
    ...
    "w r" '(winner-redo :which-key "redo layout")
